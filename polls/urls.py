...
urlpatterns = [
    ...
    path('hotel/', views.hotel_create_view, name='create_hotel'),
    path('hotel/<int:pk>/', views.hotel_detail_view, name='detail_hotel'),
    path('hotel/<int:pk>/', views.hotel_edit_view, name='edit_hotel'),
    path('hotel/<int:pk>/', views.hotel_delete_view, name='delete_hotel'),

    path('room/', views.room_list_view, name='rooms'),
    path('room/', views.room_create_view, name='create_room'),
    ...
    path('room/<int:pk>/', views.room_edit_view, name='edit_room'),
    path('room/<int:pk>/', views.room_delete_view, name='delete_room'),

    path('room-type/', views.room_type_list_view, name='room_type_list_view'),
    path('room-type/', views.room_type_create_view, name='room_type_create_view'),
    path('room-type/<str:pk>/', views.room_type_detail_view, name='room_type_detail_view'),
    path('room-type/<str:pk>/', views.room_type_edit_view, name='room_type_edit_view'),
    path('room-type/<str:pk>/', views.room_type_delete_view, name='room_type_delete_view'),

    path('province/', views.province_list_view, name='province'),
    path('province/', views.province_create_view, name='create_province'),
    path('province/<int:pk>/', views.province_detail_view, name='detail_province'),
    path('province/<int:pk>/', views.province_edit_view, name='edit_province'),
    path('province/<int:pk>/', views.province_delete_view, name='delete_province'),

    path('feature/', views.feature_list_view, name='feature_list_view'),
    path('feature/', views.feature_create_view, name='feature_create_view'),
    path('feature/<str:pk>/', views.feature_detail_view, name='feature_detail_view'),
    path('feature/<str:pk>/', views.feature_edit_view, name='feature_edit_view'),
    path('feature/<str:pk>/', views.feature_delete_view, name='feature_delete_view'),

    path('feature-hotel/', views.feature_hotel_list_view, name='feature_hotel_list_view'),
    path('feature-hotel/', views.feature_hotel_create_view, name='feature_hotel_create_view'),
    path('feature-hotel/<int:pk>/', views.feature_hotel_detail_view, name='feature_hotel_list_view'),
    path('feature-hotel/<str:pk>/', views.feature_hotel_edit_view, name='feature_hotel_edit_view'),
    path('feature-hotel/<str:pk>/', views.feature_hotel_delete_view, name='feature_hotel_delete_view'),

    path('city/', views.city_list_view, name='city_list_view'),
    path('city/', views.city_create_view, name='city_create_view'),
    path('city/<str:pk>/', views.city_detail_view, name='city_detail_view'),
    path('city/<str:pk>/', views.city_edit_view, name='city_edit_view'),
    path('city/<str:pk>/', views.city_delete_view, name='city_delete_view'),

    path('country/', views.country_list_view, name='country_list_view'),
    path('country/', views.country_create_view, name='country_create_view'),
    path('country/<str:pk>/', views.country_detail_view, name='country_detail_view'),
    path('country/<str:pk>/', views.country_edit_view, name='country_edit_view'),
    path('country/<str:pk>/', views.country_delete_view, name='country_delete_view'),
    ...
    path('staff/booking/<int:pk>/', views.staff_booking_edit_view, name='staff_booking_edit_view'),
    path('booking/<int:pk>/', views.staff_booking_delete_view, name='staff_booking_delete_view'),
